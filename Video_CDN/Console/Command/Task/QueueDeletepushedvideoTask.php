 ...
 *
 */
class QueueDeletepushedvideoTask extends QueueTask {
 ...
 */
	public function add() {
		$this->out('Delete-pushed-video task.');
		$this->hr();
...
*/
		...
		$this->Contact->save($contact,$validate=false);
		$this->out('Successfully deleted video in local storage. Updated \'status\' in DB');
